...
Revision ID: 473bf622732a
Revises: 
Create Date: 2025-10-14 21:27:43.837297
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(length=255), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('type', sa.Enum('bank', 'credit', 'venmo', 'splitwise', 'cash'), nullable=False),
    ...
    sa.Column('id', sa.String(length=255), nullable=False),
    sa.Column('source', sa.Enum('venmo', 'splitwise', 'stripe', 'cash', 'manual'), nullable=False),
