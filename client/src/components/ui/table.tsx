...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-12 px-3 md:px-4 text-left align-middle font-medium text-foreground font-body text-sm",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-3 py-3 md:px-4 md:py-3 align-middle text-foreground font-body text-sm",
        className
      )}
      {...props}
    />
